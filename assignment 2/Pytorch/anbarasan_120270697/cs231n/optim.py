...
def sgd_momentum(w, dw, config=None):
    ...
    # updating weights with velocities
...
def rmsprop(w, dw, config=None):
    ...
    ###########################################################################
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    # updating weights by moving averages of gradients
